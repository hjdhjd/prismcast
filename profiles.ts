...
export const SITE_PROFILES: Record<string, SiteProfile> = {
  ...
  // Profile for multi-channel live TV pages that work like apiMultiVideo but start playing immediately after tile selection without requiring a play button click.
  // Uses the fullscreen API and multi-video selection. The site automatically begins playback when the tile is clicked.
  apiMultiVideoDirect: {

    channelSelection: { strategy: "tileClickDirect" },
    description: "Multi-channel live TV pages requiring tile-based channel selection with immediate playback (no play button).",
    extends: "fullscreenApi",
    selectReadyVideo: true,
    summary: "Multi-channel live TV (direct play)"
  },
