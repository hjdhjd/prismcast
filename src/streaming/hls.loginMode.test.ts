...
// Minimal login-page stub. startLoginMode opens a page and calls goto/on against it, neither of which needs real behavior here; the stub mirrors the login.test.ts
// and precaching.revalidation.test.ts shape.
