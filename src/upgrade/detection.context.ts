 ...
 * a DetectionContext; this file is the only place in the detection layer that reads import.meta.url, calls execSync, or touches the filesystem (lifecycle.context.ts
 * separately owns the execSync call that runs the upgrade command itself). Tests bypass this file entirely by constructing DetectionContext literals inline.
 *
