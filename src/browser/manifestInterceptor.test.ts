 ...
 *
 * manifestInterceptor.test.ts: Unit tests for the pure URL-selection helper that backs installManifestInterceptor()'s finalize() resolution. Full CDP-driven
 * integration of the interceptor is exercised through src/native/index.test.ts; this file isolates the selection rules - master-priority and direct vs guide
 * tune semantics - so they remain locked against silent regression.
 */
