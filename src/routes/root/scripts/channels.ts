...
export function generateChannelsSubtabScript(): string {
  ...
  return [
    ...
    "      })",
    "      .catch(function(err) { console.error('Profile delete error:', err); showToast('Failed to delete profile.', 'error'); });",
    "  };",
    ...
    "        }",
    "      })",
    "      .catch(function(err) { console.error('Provider pack import error:', err); closeImportModal(); showToast('Import request failed.', 'error'); });",
    "  };",
    ...
    "        if(data.patch) { applyChannelPatch(data.patch); }",
    "      })",
    "      .catch(function(err) { console.error('Setup finish error:', err); setupWizard.close(); });",
    "  };",
