...
export function generateChannelsSubtabScript(): string {
  ...
  return [
    ...
    "      html += '<input type=\"text\" id=\"wizard-profile-name\" value=\"' + s.profileName.replaceAll('\"', '&quot;') +",
    ...
    "          if(f.type === 'text') {",
    "            const val = (s.strategyFields[f.id] || '').replaceAll('\"', '&quot;');",
    ...
    "            if(f.placeholder) html += ' placeholder=\"' + f.placeholder.replaceAll('\"', '&quot;') + '\"';",
    "            html += '>';",
    ...
    "        html += '<input type=\"text\" class=\"domain-input\" value=\"' + d.domain.replaceAll('\"', '&quot;') + '\" placeholder=\"e.g., watch.sling.com\">';",
    "        html += '</div>';",
    "        html += '<div class=\"field-group\">';",
    "        html += '<label class=\"wizard-label\">Service Name</label>';",
    "        html += '<input type=\"text\" class=\"provider-input\" value=\"' + d.service.replaceAll('\"', '&quot;') + '\" placeholder=\"e.g., Sling TV\">';",
    "        html += '</div>';",
    "        html += '<div class=\"field-group\">';",
    "        html += '<label class=\"wizard-label\">Service Tag <span style=\"color: var(--text-muted);\">(auto-filled)</span></label>';",
    "        html += '<input type=\"text\" class=\"provider-tag-input\" value=\"' + d.serviceTag.replaceAll('\"', '&quot;') +",
