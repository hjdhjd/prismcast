...
export function generateChannelsSubtabScript(): string {
  ...
  return [
    ...
    "          desc: 'For single-channel sites whose player exposes JavaScript\\'s requestFullscreen() API.' },",
    "        { key: 'keyboard', title: 'Keyboard Fullscreen',",
    "          desc: 'For single-channel sites whose player toggles fullscreen with the \\'f\\' key.' },",
