...
export function generateConfigSubtabScript(): string {
  ...
  return [
    ...
    "        }",
    "      })",
    "      .catch(function(err) { console.error('M3U import error:', err); showToast('Failed to import M3U: ' + err.message, 'error'); });",
    "      fileInput.value = '';",
    "    };",
    "    reader.readAsText(file);",
    "  };",
    ...
    "      .then(function(result) {",
    "        if(result.ok && result.data.success) {",
    "          if(result.data.patch) { applyChannelPatch(result.data.patch); }",
    "        } else {",
    "          td.innerHTML = original;",
    "          showToast(result.data.message || 'Failed to save.', 'error');",
    "        }",
    "      })",
    "      .catch(function(err) { console.error('Inline edit error:', err); td.innerHTML = original; showToast('Failed to save: ' + err.message, 'error'); });",
    "    }",
    ...
    "      }",
    "    })",
    "    .catch(function(err) { console.error('Channel save error:', err); showToast('Failed to save channel: ' + err.message, 'error'); });",
    "    return false;",
    "  };",
    ...
    "      }",
    "    })",
    "    .catch(function(err) { console.error('Channel delete error:', err); showToast('Failed to delete channel: ' + err.message, 'error'); });",
    "  };",
    ...
    "      }",
    "    })",
    "    .catch(function(err) { console.error('Channel toggle error:', err); showToast('Failed to toggle channel: ' + err.message, 'error'); });",
    "  };",
    ...
    "      }",
    "    })",
    "    .catch(function(err) { console.error('Provider update error:', err); showToast('Failed to update provider: ' + err.message, 'error'); });",
    "  };",
    ...
    "      }",
    "    })",
    "    .catch(function(err) { console.error('Bulk toggle error:', err); showToast('Failed to toggle channels: ' + err.message, 'error'); });",
    "  };",
    ...
    "  window.autoNumberChannels = function() {",
    ...
    "    fetch('/config/channels/auto-number', {",
    "      method: 'POST',",
    "      headers: { 'Content-Type': 'application/json' },",
    ...
    "      }",
    "    })",
    "    .catch(function(err) { console.error('Auto-number error:', err); showToast('Failed to auto-number channels: ' + err.message, 'error'); });",
    "  };",
    ...
    "      }",
    "    })",
    "    .catch(function(err) { console.error('Provider filter error:', err); showToast('Failed to update filter: ' + err.message, 'error'); });",
    "  };",
