...
export function generateHelpContent(): string {
  ...
  return [
    ...
    "<p>PrismCast renders every page at the resolution of the selected quality preset and captures that rendered surface, so <strong>capture resolution does not ",
    "depend on the size of your display</strong>. A 1080p preset captures at 1920&times;1080 on a small laptop screen exactly as it does on a large monitor.</p>",
    ...
    "the selected preset regardless &mdash; the window you would see on screen simply cannot show a whole frame.</p>",
